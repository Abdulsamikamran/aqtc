...
const MorphingNavigation = ({
  ...
  const getThemeStyles = useCallback(() => {
    switch (theme) {
      ...
      case 'glass':
        return {
          nav: 'bg-[#066787]/90 border-[#066787]',
          text: 'text-white',
  ...
  return (
    <>
      ...
      <header
        ref={headerRef}
        className={cn('fixed z-50 transition-all duration-500 ease-in-out', className)}
          ...
          >
            {customHamburgerIcon || (
              <div className="flex flex-col items-center justify-center h-full">
                <span
                  className={cn('block h-0.5 bg-current transition-all duration-600 ease-in-out', {
